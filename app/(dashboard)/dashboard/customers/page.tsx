...
import { LoyaltyClubView } from "@/components/dashboard/loyalty-club-view";
        ...
        <CustomersView
          ...
          loyaltyClub={
            <LoyaltyClubView
              ...
              audienceCounts={loyaltyAudienceCounts}
              cashbackSettings={{
                cashbackEnabled: business.cashbackEnabled,
                cashbackPercent: business.cashbackPercent,
                cashbackCapPerOrder: business.cashbackCapPerOrder,
              }}
              birthdaySettings={{
                birthdayMessageEnabled: business.birthdayMessageEnabled,
