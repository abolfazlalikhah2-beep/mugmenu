const faqs = [
  ...
  },
  {
    ...
    answer:
      "می‌توانید از همان پلن پایه «فیروزه» شروع کنید و هر زمان به سفارش‌گیری روی میز، بیرون‌بر یا ارسال با پیک نیاز داشتید، به پلن «اوپال» یا «زمرد» ارتقا دهید — منو و اطلاعات رستوران‌تان بدون تغییر باقی می‌ماند.",
  },
];
