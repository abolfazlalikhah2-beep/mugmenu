  ...
  return (
    <div className="flex flex-col gap-3 rounded-[22px] bg-card p-[20px_18px] shadow-[0px_8px_17.5px_rgba(0,0,0,0.03)] sm:p-[26px_30px]">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <div className="text-[15px] font-semibold sm:text-base">روند بازدید — ۱۴ روز اخیر</div>
          <div className="mt-0.5 text-xs font-light text-text-3">بازدید یکتا منوی آنلاین</div>
        </div>
        <div className="flex items-center gap-1.5">
          <span className="h-[3px] w-2.5 rounded-sm bg-brand" />
          <span className="text-[11px] text-text-3">بازدید</span>
        </div>
      </div>
      <svg viewBox={`0 0 ${W} ${H}`} preserveAspectRatio="none" className="h-[170px] w-full sm:h-[200px]">
        <defs>
          <linearGradient id="menuVisitTrendFill" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#328C3D" stopOpacity="0.18" />
            <stop offset="100%" stopColor="#328C3D" stopOpacity="0.01" />
          </linearGradient>
        </defs>
        <path d={area} fill="url(#menuVisitTrendFill)" />
        <path
          d={line}
          fill="none"
          stroke="#328C3D"
